  ...
  >
    <template #title>
      <a-row type="flex" align="middle">
        <a-col :span="24" :md="12">
          <h5 class="font-semibold m-0">团队资源</h5>
        </a-col>
        <a-col
          :span="24"
          :md="12"
    ...
    <a-table
      ...
      v-show="projectHeaderBtns == 'article'"
    >
      ...
      <template slot="mainText" slot-scope="mainText">
        <div class="text-sm font-semibold text-muted pr-15">
          {{ mainText }}
        </div>
      </template>

      <template slot="employed" slot-scope="employed">
        <div class="text-sm font-semibold text-muted pr-15">
          {{ employed }}
        </div>
      </template>
